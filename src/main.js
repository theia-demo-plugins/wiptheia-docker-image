...
// // cp.spawnSync('cd /home/testtheia/examples/browser && yarn theia start /projects --hostname=0.0.0.0');
// const options = {};
// options.cwd = '/home/testtheia/examples/browser';
// // cp.spawnSync('yarn', ['theia', 'start', '/projects', '--hostname=0.0.0.0'], options);
// cp.spawn('yarn', ['theia', 'start', '/projects', '--hostname=0.0.0.0'], options);
// // cp.exec('yarn theia start /projects --hostname=0.0.0.0', options);
// return;
